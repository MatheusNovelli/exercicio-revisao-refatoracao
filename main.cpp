...
int main() {
  ...
  std::cout << "Quota vendas: " << vend1.getQuotaAnual() << std::endl;
  std::cout << std::endl;
  ...
  std::cout << "Quota vendas: " << vend2.getQuotaAnual() << std::endl; 
  std::cout << std::endl;  
  ...
  std::cout << "Quota vendas: " << vend3.getQuotaAnual() << std::endl;  
